...
public final class SVGParsingUtils {
	...
	public static void writeSVG(SVGGraphic processed, String pathOutput) {
		...
		try {
			...
			ArrayList<ColoredPolygon> pols = new ArrayList<>(Arrays.asList(processed.shapes));
	...
	private static ArrayList<ColoredPolygon> triangulate(ColoredPolygon proc2) {
		ArrayList<ColoredPolygon> toReturn = new ArrayList<>();
		ColoredPolygon pol;
	...
	public static SVGGraphic splitIntoMonotones(SVGGraphic polytonics) {
		...
		ArrayList<ColoredPolygon> candidate = new ArrayList<>();

		ArrayList<ColoredPolygon> pols = new ArrayList<>(Arrays.asList(polytonics.shapes));
