...
public class TotautisSpaceStation extends Place {
    ...
    public TotautisSpaceStation() {
        ...
        floor2.addNewLocation("control room")
                .setDescription("Lots of old equiptment.").addItem(new Book(BOOK7_TITLE, BOOK7_TEXT))
                .addItem(new Equipment("computer-stand").setDescription("JACKPOT! A very valuable vintage rare-and-in-working-conditions computer rack!"));
        ...
        floor3.addNewLocation("lab 1")
                .setDescription("A micro-g-hydrostatic lab. Lots of old equipments. There must be something valuable here.")
                .addItem(new Book(BOOK0_TITLE, BOOK0_TEXT)).addItem(new MetalPlate("metal-scrap").setPickable(false));
        ...
        floor3.addNewLocation("lab 3")
                .setDescription("Looks like this was a chemistry lab. Looks badly destroyed. I was told this was due to space-trash. That's why they got us! On the left wall, there are remnants of a 3D periodic table. If only this was in once piece, it could make some good cash.")
                .addItem(new Book(BOOK6_TITLE, BOOK6_TEXT)).addItem(new Pipe(null));
