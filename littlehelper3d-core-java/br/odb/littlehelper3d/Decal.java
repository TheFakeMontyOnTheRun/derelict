 ...
 *
 */
public class Decal extends GLESMesh {
	...
	public static final GLES1Triangle[] loadGraphic(InputStream is, float screenWidth, float screenHeight )
			throws IOException {
	...
	private static GLES1Triangle[] loadFrom( InputStream is, float offset, float screenWidth, float screenHeight ) throws IOException {
		...
		ArrayList< GLES1Triangle> scratch = new ArrayList< GLES1Triangle>();
...
//				}
	...
	public Decal( FileServerDelegate fileServer, String decalName, String decalFilename, float screenWidth, float screenHeight ) {
		...
		try {			
			...
			GLES1Triangle[] trigs = loadFrom( is, 0.0f, screenWidth, screenHeight );
