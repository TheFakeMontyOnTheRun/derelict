...
import br.odb.derelict.core.ClearanceException;
...
public class SecuredDoorTest {
	...
	/**
	 * Test method for
	 * {@link br.odb.derelict.core.SecuredDoor#openFor(br.odb.gamelib.gameworld.CharacterActor)}
	 * .
	 */
	@Test
