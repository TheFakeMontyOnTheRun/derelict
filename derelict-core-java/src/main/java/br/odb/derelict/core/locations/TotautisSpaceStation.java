...
import br.odb.derelict.core.ScheduledSpookySound;
...
public class TotautisSpaceStation extends Place {
	...
	public static final int TIME_FOR_ORBITAL_DECAY = 17 * Utils.MINUTE_IN_MILISSECONDS;
	public static final int TIMEBOMB_DEFAULT_FUSE_TIME = 4 * Utils.MINUTE_IN_MILISSECONDS;
	...
	public static final String BOOK0_TEXT = "...And so, I realized that when you apply a presure in MicroG..."; 
	public static final String BOOK1_TEXT = "...It is said that the old ones we very cautious, but still, they launched several men, women and animals into space, with little to no chance of survival...";
	public static final String BOOK2_TEXT = "...Look in the mirror e try laughing. It's going to be hard first, but once you get used to it, it is easy to leave the room with a smile in your face."; 
	public static final String BOOK3_TEXT = "...We meet every night in the empty lab, to make out. I asked her for a access key and hid it in the tubes - probably a good place to hide it. Those are inactive for years! If they catch me, I'm scr..."; 
	public static final String BOOK4_TEXT = "Today, I lost card during dinner. Gonna ask for a new one. Specially disconcerting since it gives access to all bunks. Nobody knows, so nothing to worry, I guess..."; 
	public static final String BOOK5_TEXT = "...and so you guys could just join in and see whats going on. I hope it is not too instrusive of me. To that, she just gave me a cold stare and..."; 
	public static final String BOOK6_TEXT = "It's badly burn't. Can't read it."; 
	public static final String BOOK7_TEXT = "[Encrypted content. Key needed: PK42C or equivalent]"; 
	public static final String BOOK8_TEXT = "..." + WEAK_SPOT + " last week mending was a real rush job. Any stronger bump and it might ..."; 

	public static final String BOOK0_TITLE = "Paper draft";  //lab1
	public static final String BOOK1_TITLE = "The lost cosmonauts"; //lounge 
	public static final String BOOK2_TITLE = "One day at a time - how to overcome a great loss"; //pod1 
	public static final String BOOK3_TITLE = "Diary";  //pod3 - katya 
	public static final String BOOK4_TITLE = "Worklog."; //pod4 
	public static final String BOOK5_TITLE = "*unlabeled volume*"; 
	public static final String BOOK6_TITLE = "Voynich Manuscript Translation."; //lab3
	public static final String BOOK7_TITLE = "[Encrypted text. Key needed: PK42C or equivalent]"; //control room
	public static final String BOOK8_TITLE = "Maintenance Report";
	...
	long timeForReentry;
	Vec2 weakSpot;
	public br.odb.utils.EventManager eventManager = new br.odb.utils.EventManager();
	...
	public TotautisSpaceStation() {
		...
		floor3.addNewLocation("lab 3")  
				.setDescription("Looks like this was a chemistry lab. Looks badly destroyed. I was told this was due to space-trash. That's why they got us!").addItem( new Book( BOOK6_TITLE, BOOK6_TEXT ) ).addItem(new Pipe( null ));  

		floor1.addNewLocation("elevator-shaft-1").setDescription("Going down? The elevator no longer works. It seems to be stuck in level 3. You have to navegate the shaft by yourself.");    

		floor2.addNewLocation("elevator-shaft-2").setDescription("Going up or down? Looking down, you can clearly see the elevator cabin in level 3.");    

		floor3.addNewLocation("elevator-shaft-3").setDescription("Going up? Fortunately, the escape hatch is open and this allows for access. The cabin itself is unremarkable.");    
		...
		try {
			getLocation("elevator-shaft-3").setConnected(Direction.CEILING,  
							getLocation("elevator-shaft-2"));  
			getLocation("elevator-shaft-2").setConnected(Direction.CEILING,  
							getLocation("elevator-shaft-1"));  

			getLocation("elevator-shaft-1").setConnected(Direction.FLOOR,  
							getLocation("elevator-shaft-2"));  
			getLocation("elevator-shaft-2").setConnected(Direction.FLOOR,  
							getLocation("elevator-shaft-3"));  

			getLocation("elevator-shaft-1").setConnected(Direction.S,  
							getLocation("main hall 1"));  
			getLocation("elevator-shaft-2").setConnected(Direction.S,  
							getLocation("main hall 2"));  
			getLocation("elevator-shaft-3").setConnected(Direction.S,  
			...
			eventManager.events
					.add(new ScheduledSpookySound(null,
							3 * Utils.MINUTE_IN_MILISSECONDS, "spooky1",  
							"You hear some creepy distorted voices.",  
							getLocation("lab 2")));  
			eventManager.events
					.add(new ScheduledSpookySound(null,
							10 * Utils.MINUTE_IN_MILISSECONDS, "spooky2",  
							"You hear a buzzing sound and some oldrussian random words.",  
							getLocation("pod 3")));  
			eventManager.events
					.add(new ScheduledSpookySound(null,
							15 * Utils.MINUTE_IN_MILISSECONDS, "spooky3",  
							"You hear a melody, followed by numbers.",  
							getLocation("elevator-shaft-2")));  
	...
	public CharacterActor addCharacter(CharacterActor c)
			throws InvalidCharacterHandlingException {

		return addCharacter(c.getName(), c);
	}
	...
	public void update(long milisseconds) {
		...
		if (milisseconds > 0) {
			...
			eventManager.update(milisseconds);
	...
	public boolean canMove(Astronaut character, String placeName) {
		...
		try {
			destination = getLocation(placeName);
		} catch (InvalidLocationException e) {
			return false;
		}
